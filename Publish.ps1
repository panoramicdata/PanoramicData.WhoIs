...
# PSScriptAnalyzer discourages Write-Host, so progress goes to the information stream instead.
# -InformationAction Continue keeps it visible by default, and $PSStyle supplies the colour that
# -ForegroundColor used to.
